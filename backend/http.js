...
var contatos = [
  ...
  { nome: "MENITO GARCIA", telefone: "99998888", data: new Date(), operadora: operadoras[0]},
  { nome: "MONA GARCIA", telefone: "923744720", data: new Date(), operadora: operadoras[1]},
  { nome: "LUCY GARCIA", telefone: "33333344", data: new Date(), operadora: operadoras[2]},
  { nome: "MARIA DE FÁTIMA", telefone: "77777744", data: new Date(), operadora: operadoras[3]},
  { nome: "MARIA DA CONCEIÇÃO", telefone: "7779999", data: new Date(), operadora: operadoras[4]}
];
...
app.get("/contatos/:id", function (req, res) {
  res.write(JSON.stringify(contato.id));
  res.end();
});
